...
--> statement-breakpoint
INSERT INTO `__new_stargazers`(`username`, `n_dates`, `n_repos`, `n_orgs`, `total_actions`, `has_organization`, `has_blog`, `has_company`, `public_repos`, `followers`, `account_created_at`, `score`, `checked_at`) SELECT `username`, `n_dates`, `n_repos`, `n_orgs`, `total_actions`, `has_organization`, `has_blog`, `has_company`, `public_repos`, `followers`, `account_created_at`, `score`, `checked_at` FROM `stargazers`;--> statement-breakpoint
